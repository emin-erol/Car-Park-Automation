...
from yardimUI import NasilKullanilirYardim
import Scripts.Kamera.sabitler as sb
import sqlite3
import sys
import threading
import goruntu_isleme as gi
from anasayfaUI import Anasayfa
...
class Pencere(QWidget):
    def __init__(self):
        ...
        self.setGeometry(400, 400, 750, 600)
    ...
    def initUI(self):
        ...
        self.footer1 = QLabel("Bilgi ve iletişim için erolemin@outlook.com.tr adresinden iletişime geçebilirsiniz.", self)
    ...
    def girisKontrolu(self):
        ...
        if self.kontrol(k_adi, sifre):
            ...
            self.anasayfa.show()
            self.close()
            threading.Thread(target=self.nesneTanimayiBaslat).start()
        else:
    ...
    def nesneTanimayiBaslat(self):
        portlar = gi.portlariAl()
        nesne_tanima = gi.GoruntuIsleme(portlar)
        nesne_tanima.multiNesneTanima()
